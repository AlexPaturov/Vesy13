...
/// код которой меньше или равен текущему коду АЦП. Если текущий код ниже
/// первой точки, используется первая точка; если выше последней — последняя.
/// Вес считается без интерполяции по коэффициенту выбранной точки:
/// текущий_код_АЦП * (масса_точки / код_АЦП_точки).
/// </summary>
