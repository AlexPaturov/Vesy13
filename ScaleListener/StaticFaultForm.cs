...
/// <summary>
/// Панель управления сбоями для статических ответов. Сам движок (<see cref="FaultEngine"/>)
/// живёт в <see cref="StaticForm"/> и продолжает работать, даже если эта панель закрыта.
///
