...
Таблицы создаются пустыми. Признаком заданной динамической калибровки служит наличие активной строки в `calibration_dynamic`, поэтому на новой станции таблица остаётся пустой до первой калибровки на эталонных грузах.
